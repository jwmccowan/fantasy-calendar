...
import { Button, Paper, Typography, useMediaQuery, Theme } from '@material-ui/core';
import styled from 'styled-components';
import { DateTime } from 'luxon';
import { CalendarHeader } from './CalendarHeader';
import { CalendarBody } from './CalendarBody';
import { ArrowBackIosRounded, ArrowForwardIosRounded } from '@material-ui/icons';
import { NewCalendarDialog } from '../NewCalendarItemDialog';
...
export const Calendar: React.FC = () => {
    ...
    const setAndToggle = React.useCallback((value: DateTime) => {
        setDate(value);
        toggle();
    }, []);
    ...
    return (
        <Well>
            ...
            <CalendarBody date={date} onSetDate={setAndToggle} />
            <NewCalendarDialog open={open} date={date} onClose={toggle} />
        </Well>
    );
};
